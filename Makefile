...
$(TARGET): ui_login.h ui_loggedin.h ui_register.h ui_editqualifications.h ui_qualframe.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/COMP30041.0.0/ && $(COPY_FILE) --parents login.h loggedin.h register.h rapidxml.hpp rapidxml_iterators.hpp rapidxml_print.hpp rapidxml_utils.hpp editqualifications.h ProfileEntity.h StorageObject.h SimpleFileStorage.h StorageManager.h MasterControl.h LoginControl.h qualframe.h .tmp/COMP30041.0.0/ && $(COPY_FILE) --parents main.cpp login.cpp loggedin.cpp register.cpp editqualifications.cpp ProfileEntity.cpp StorageObject.cpp SimpleFileStorage.cpp StorageManager.cpp MasterControl.cpp LoginControl.cpp qualframe.cpp .tmp/COMP30041.0.0/ && $(COPY_FILE) --parents login.ui loggedin.ui register.ui editqualifications.ui qualframe.ui .tmp/COMP30041.0.0/ && (cd `dirname .tmp/COMP30041.0.0` && $(TAR) COMP30041.0.0.tar COMP30041.0.0 && $(COMPRESS) COMP30041.0.0.tar) && $(MOVE) `dirname .tmp/COMP30041.0.0`/COMP30041.0.0.tar.gz . && $(DEL_FILE) -r .tmp/COMP30041.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_login.cpp moc_loggedin.cpp moc_register.cpp moc_editqualifications.cpp moc_qualframe.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_login.cpp moc_loggedin.cpp moc_register.cpp moc_editqualifications.cpp moc_qualframe.cpp
...
compiler_uic_make_all: ui_login.h ui_loggedin.h ui_register.h ui_editqualifications.h ui_qualframe.h
compiler_uic_clean:
	-$(DEL_FILE) ui_login.h ui_loggedin.h ui_register.h ui_editqualifications.h ui_qualframe.h
ui_login.h: login.ui
